...
VALUES
  ('GTI Asia 2026 — Book Your Booth', 'NexAmuse Media', 'homepage', 'Homepage Hero Banner', '1200x100', 'active', NULL, '/pages/suppliers.html', 'GTI Asia 2026', '🎪', '2026-01-01', '2027-12-31', 'CPM', 0, 0, 0, 0, 5, strftime('%s','now'), strftime('%s','now')),
